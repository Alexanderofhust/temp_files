  ...
  export NAVSIM_EXP_ROOT="/data/shengzhenli/DiffusionDrive/diffusiondrive_score_eval_exp"
  ...
  CHECKPOINT="/data/shengzhenli/DiffusionDrive/diffusiondrive_score_exp/lightning_logs/version_0/checkpoints/last.ckpt"
  ...
  python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_pdm_score.py \
      ...
      experiment_name=diffusiondrive_score_eval \
