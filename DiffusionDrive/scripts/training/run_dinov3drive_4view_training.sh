...
export NAVSIM_EXP_ROOT="/data/shengzhenli/DiffusionDrive/dinov3drive_4view_exp"
...
python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training.py \
        ...
        experiment_name=training_dinov3drive_4view_agent  \
        train_test_split=navtrain  \
        split=trainval   \
        trainer.params.max_epochs=100 \
        use_cache_without_dataset=True  \
        force_cache_computation=False \
        cache_path="/data/shengzhenli/DiffusionDrive/dinov3drive_4view_exp/training_cache" 