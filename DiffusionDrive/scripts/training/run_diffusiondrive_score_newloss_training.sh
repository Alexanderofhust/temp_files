...
export NAVSIM_EXP_ROOT="/data/shengzhenli/DiffusionDrive/diffusiondrive_score_newloss_exp"
...
DATA_CACHE_PATH="/data/shengzhenli/DiffusionDrive/diffusiondrive_score_dataset_cache/training_cache"
SCORE_CACHE_PATH="/data/shengzhenli/DrivoR-main/exp/train_metric_cache"

python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training.py \
    agent=diffusiondrive_score_newloss_agent \
    experiment_name=training_diffusiondrive_score_newloss_agent \
