...
class TransfuserConfig:
    ...
    # v2_99 model weights path (if provided, will use VoVNet-99 instead of image_architecture)
    v2_99_weights_path: str = "/data/shengzhenli/DiffusionDrive/navsim/agents/v2_99/dd3d_det_final.pth"
