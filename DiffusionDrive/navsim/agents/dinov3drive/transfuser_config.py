...
class TransfuserConfig:
    ...
    image_architecture: str = 'vit_small_patch16_dinov3.lvd1689m'
    ...
    camera_width: int = 576
    camera_height: int = 320
    image_size: Tuple[int, int] = (576, 320)
    image_encoder_size: Tuple[int, int] = (576, 320)
    lidar_resolution_width = 256
    lidar_resolution_height = 256

    img_vert_anchors: int = image_size[1] // 32
    img_horz_anchors: int = image_size[0] // 32
    lidar_vert_anchors: int = 256 // 32
    lidar_horz_anchors: int = 256 // 32
    num_cameras: int = 4
    num_scene_tokens: int = 16
    image_encoder_pretrained: bool = True
    image_encoder_finetune: bool = True
    image_encoder_use_lora: bool = True
    image_encoder_lora_rank: int = 32
    image_encoder_out_indices: Tuple[int, int, int, int] = (5, 7, 9, 11)
    use_image_register_tokens: bool = True
    image_register_vert_anchors: int = img_vert_anchors
    image_register_horz_anchors: int = img_horz_anchors
    image_register_source_vert_anchors: int = image_encoder_size[1] // 32
    image_register_source_horz_anchors: int = image_encoder_size[0] // 32
    image_register_num_heads: int = 4
    image_register_ff_mult: int = 2
