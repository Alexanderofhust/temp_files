...
class TransfuserConfig:
    ...
    bkb_path: str = "/data/shengzhenli/DiffusionDrive/pytorch_model.bin"
    ...
    trajectory_cls_pdm_weight: float = 1.0
    trajectory_cls_tau: float = 0.05
    trajectory_cls_use_soft_target: bool = True
    ...
    score_ray_threads_per_node: int = 8
    # BEV mapping
