...
from navsim.agents.diffusiondrive_score.transfuser_model_v2 import V2TransfuserModel as TransfuserModel
from navsim.agents.diffusiondrive_score.transfuser_callback import TransfuserCallback
from navsim.agents.diffusiondrive_score.transfuser_loss import transfuser_loss
from navsim.agents.diffusiondrive_score.transfuser_features import (
...
from navsim.agents.diffusiondrive_score.modules.scheduler import WarmupCosLR
...
class TransfuserAgent(AbstractAgent):
    ...
    def _initialize_score_supervision(self) -> None:
        from navsim.agents.diffusiondrive_score.score_module.compute_navsim_score import get_scores
