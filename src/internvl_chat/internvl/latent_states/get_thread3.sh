...
export CUDA_VISIBLE_DEVICES=3  # 指定使用的GPU设备（根据需要修改）
# ==========================
# 核心配置（按需修改）
# ==========================
MODEL_PATH="/data2/chenxiwu/Drive/recogdrive/tune_output/tune_gptdrive_traj_only_cot"
DATA_JSON="/data1/chenxiwu/ICoT/data/original_data/part_3.jsonl"
OUTPUT_DIR="/data1/chenxiwu/ICoT/data/m_hs/test_1"
IMAGE_ROOT=""
