...
class TransfuserConfig:
    ...
    bkb_path: str = "/data/shengzhenli/navsim-1.1/navsim/agents/diffusiondrive/pytorch_model.bin"
    plan_anchor_path: str = "/data/shengzhenli/DiffusionDrive/kmeans_navsim_traj_20.npy"

    # Theia model configuration (directly use Theia instead of timm ViT)
    theia_model_name: str = "theaiinstitute/theia-small-patch16-224-cddsv"
    theia_feature_reduce_method: str = None  # None keeps spatial features [B, H*W, C]

    theia_weights_path: str = "/data/shengzhenli/DiffusionDrive/navsim/agents/theia/rvfm_dp1.000_facebook-deit-small-patch16-224_lconv_radio_step00018715.pth"
    #theia_weights_path: str = "/data/shengzhenli/DiffusionDrive/navsim/agents/theia/rvfm_dp1.000_facebook-deit-small-patch16-224_lconv_navsim_stitch_dinov3_step00049250.pth"
    #camera only
    latent: bool = False
    ...
    final_score_weight: float = 10.0
    agent_class_weight: float = 10.0
    agent_box_weight: float = 1.0
    bev_semantic_weight: float = 14.0
    use_ema: bool = False
    use_score_head: bool = True
    score_select_trajectory: bool = True
    score_num_layers: int = 2
    score_num_heads: int = 8
    score_noc_weight: float = 1.0
    score_dac_weight: float = 1.0
    score_ddc_weight: float = 0.0
    score_ttc_weight: float = 5.0
    score_ep_weight: float = 5.0
    score_comfort_weight: float = 2.0
    score_cache_dir: str = "train_metric_cache"
    score_cache_lru_size: int = 256
    score_use_ray: bool = True
    # BEV mapping
